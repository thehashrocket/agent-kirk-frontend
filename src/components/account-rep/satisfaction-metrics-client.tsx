...
import type { SatisfactionMetrics } from "@/lib/account-rep";

interface SatisfactionMetricsClientProps {
...
export function SatisfactionMetricsClient({ 
  metrics, 
  distributionData, 
  formattedTrendData 
}: SatisfactionMetricsClientProps) {
  return (
